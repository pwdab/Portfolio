...
GLfloat bus_color[3] = { 0.96f, 0.64f, 0.0f };

void prepare_my_bus_20191576(void) {
	...
	sprintf(filename, "Data/static_objects/bus/bus_vnt.geom");
...
void draw_my_bus_20191576(void) {
	glUseProgram(h_ShaderProgram_simple);

	ModelViewMatrix = glm::translate(ViewMatrix, glm::vec3(-1650.0f, 850.0f, 50.0f));
	ModelViewMatrix = glm::rotate(ModelViewMatrix, 45 * TO_RADIAN, glm::vec3(0.0f, 0.0f, 1.0f));
